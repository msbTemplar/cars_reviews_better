"""
Django settings for cars_reviews_better project.
...
SECRET_KEY = 'django-insecure-1u*40*tmqz%%f!padrc+e-a-6o#qi#uxf&-f-k&x7=py27-^1o'
...
ROOT_URLCONF = 'cars_reviews_better.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [BASE_DIR /'cars_reviews_better_app/templates/cars_reviews_better_app/'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
                ...
                'cars_reviews_better_app.context_processors.debug_context', 
            ],
        },
    },
]

WSGI_APPLICATION = 'cars_reviews_better.wsgi.application'
