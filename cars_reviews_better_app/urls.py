"""
URL configuration for cars_reviews_better project.
...
urlpatterns = [
    ...
    path('topgear/', views.topgear_view, name='topgear'),
    path('caranddriver/', views.caranddriver_view, name='caranddriver'),
